...
//   June 13, 2011, 3:00 pm with psd2css Online version 1.95
...
$(document).ready(function(){
  ...
  $("#Layer-43").addClass("Wrap-42-43").hide();
  $("#Layer-42").addClass("Wrap-42-43");
  $(".Wrap-42-43").hover(
    function(){ $("#Layer-43").show(); $("#Layer-42").hide(); },
    function(){ $("#Layer-42").show(); $("#Layer-43").hide(); });

  // Initialize the slidecontainer and slidepane features.  We use the
  // scrollable part of the jquery Tools UI available at http://flowplayer.org.
  // There are lots of options available, we've added a couple here.  Check out
  // the docs at their site for more.
  $("div.slidecontainer").scrollable({ size: 1 })
    // If you don't want your scrollpanes to automatcially advance every 5 seconds,
    // then just comment out the next line.  If you want them to auto advance
    // at a different rate just change the interval number there.
